...
function drawGraphic() {
  ...
  var height = (config.optional.seriesHeight[size] * graphic_data.length) + (10*(namesUnique.length-1)) + 10
  ...
  const y = d3.scaleBand()
    .paddingOuter(0.2)
    .paddingInner((namesUnique.length-1)*10/(graphic_data.length*30))
    .range([0, height])
    .round(true);
